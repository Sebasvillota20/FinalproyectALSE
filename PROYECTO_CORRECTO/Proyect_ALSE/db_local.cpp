...
/*bool Db_local::guardar_datos(examen &ex){
    //  CREATE TABLE "examen" ( `ID` INTEGER PRIMARY KEY AUTOINCREMENT,`doc` NUMERIC NOT NULL,`tiempo` NUMERIC NOT NULL  )
    char *zErrMsg=0;
    int rc;
  std::stringstream sql;
    sql << "INSERT INTO paciente (doc, tiempo) VALUES ('" ;
    sql<<ex.getTiempo()<< "', '" <<ex.getCedula()<<");";
